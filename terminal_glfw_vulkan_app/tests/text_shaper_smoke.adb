...
procedure Text_Shaper_Smoke is
   ...
   Brahmi    : RM.Text_Run_Command := Run (16#11005#);
   Kaithi    : RM.Text_Run_Command := Run (16#11085#);
   Chakma    : RM.Text_Run_Command := Run (16#11103#);
   Mahajani  : RM.Text_Run_Command := Run (16#11150#);
   Sharada   : RM.Text_Run_Command := Run (16#11183#);
   Khojki    : RM.Text_Run_Command := Run (16#11208#);
   Khudawadi : RM.Text_Run_Command := Run (16#112B0#);
   ...
   Limbu    : RM.Text_Run_Command := Run (16#1900#);
   Tai_Le   : RM.Text_Run_Command := Run (16#1950#);
   New_Tai_Lue : RM.Text_Run_Command := Run (16#1980#);
   ...
   Syloti    : RM.Text_Run_Command := Run (16#A800#);
   Phags_Pa  : RM.Text_Run_Command := Run (16#A840#);
   Saurashtra : RM.Text_Run_Command := Run (16#A880#);
   Kayah_Li  : RM.Text_Run_Command := Run (16#A900#);
   Rejang    : RM.Text_Run_Command := Run (16#A930#);
   ...
   Tai_Viet  : RM.Text_Run_Command := Run (16#AA80#);
   Meetei    : RM.Text_Run_Command := Run (16#ABC0#);
...
begin
   ...
   Assert_Complex_Script (Brahmi, RM.Script_Brahmi, "Brahmi");
   Assert_Complex_Script (Kaithi, RM.Script_Kaithi, "Kaithi");
   Assert_Complex_Script (Chakma, RM.Script_Chakma, "Chakma");
   Assert_Complex_Script (Mahajani, RM.Script_Mahajani, "Mahajani");
   Assert_Complex_Script (Sharada, RM.Script_Sharada, "Sharada");
   Assert_Complex_Script (Khojki, RM.Script_Khojki, "Khojki");
   Assert_Complex_Script (Khudawadi, RM.Script_Khudawadi, "Khudawadi");
   ...
   Assert_Complex_Script (Limbu, RM.Script_Limbu, "Limbu");
   Assert_Complex_Script (Tai_Le, RM.Script_Tai_Le, "Tai Le");
   Assert_Complex_Script (New_Tai_Lue, RM.Script_New_Tai_Lue, "New Tai Lue");
   ...
   Assert_Complex_Script (Syloti, RM.Script_Syloti_Nagri, "Syloti Nagri");
   Assert_Complex_Script (Phags_Pa, RM.Script_Phags_Pa, "Phags-pa");
   Assert_Complex_Script (Saurashtra, RM.Script_Saurashtra, "Saurashtra");
   Assert_Complex_Script (Kayah_Li, RM.Script_Kayah_Li, "Kayah Li");
   Assert_Complex_Script (Rejang, RM.Script_Rejang, "Rejang");
   ...
   Assert_Complex_Script (Tai_Viet, RM.Script_Tai_Viet, "Tai Viet");
   Assert_Complex_Script (Meetei, RM.Script_Meetei_Mayek, "Meetei Mayek");
