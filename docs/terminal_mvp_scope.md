...
Khojki, Khudawadi, Grantha, Newa, Tirhuta, Thai, Lao, Myanmar, Mongolian,
Khmer, Javanese,
...
Central Asian, minority scripts, and CJK/Han coverage when those files are
installed and loadable by `textrender`. Each shaped glyph stores
